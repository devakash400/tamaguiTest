...
var ACCORDION_NAME = "Accordion", ACCORDION_KEYS = [
  ...
  "ArrowLeft",
  "ArrowRight"
], _createCollection = _sliced_to_array(createCollection(ACCORDION_NAME), 2), Collection = _createCollection[0], useCollection = _createCollection[1], ACCORDION_CONTEXT = "Accordion", AccordionComponent = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  ...
  return /* @__PURE__ */ _jsx(Collection.Provider, {
    ...
    children: type2 === "multiple" ? /* @__PURE__ */ _jsx(AccordionImplMultiple, _object_spread_props(_object_spread({}, multipleProps), {
      ref: forwardedRef
    })) : /* @__PURE__ */ _jsx(AccordionImplSingle, _object_spread_props(_object_spread({}, singleProps), {
      ref: forwardedRef
    }))
  });
});
...
var _createStyledContext = createStyledContext(), AccordionValueProvider = _createStyledContext.Provider, useAccordionValueContext = _createStyledContext.useStyledContext, _createStyledContext1 = createStyledContext(), AccordionCollapsibleProvider = _createStyledContext1.Provider, useAccordionCollapsibleContext = _createStyledContext1.useStyledContext, AccordionImplSingle = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  ...
  return /* @__PURE__ */ _jsx(AccordionValueProvider, {
    ...
    children: /* @__PURE__ */ _jsx(AccordionCollapsibleProvider, {
      scope: props.__scopeAccordion,
      collapsible,
      children: /* @__PURE__ */ _jsx(AccordionImpl, _object_spread_props(_object_spread({}, accordionSingleProps), {
        ref: forwardedRef
      }))
    })
  });
  ...
  return /* @__PURE__ */ _jsx(AccordionValueProvider, {
    ...
    children: /* @__PURE__ */ _jsx(AccordionCollapsibleProvider, {
      scope: props.__scopeAccordion,
      collapsible: !0,
      children: /* @__PURE__ */ _jsx(AccordionImpl, _object_spread_props(_object_spread({}, accordionMultipleProps), {
        ref: forwardedRef
      }))
    })
  });
}), _createStyledContext2 = createStyledContext(), AccordionImplProvider = _createStyledContext2.Provider, useAccordionContext = _createStyledContext2.useStyledContext, AccordionImpl = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  var __scopeAccordion = props.__scopeAccordion, disabled = props.disabled, dir = props.dir, _props_orientation = props.orientation, orientation = _props_orientation === void 0 ? "vertical" : _props_orientation, accordionProps = _object_without_properties(props, [
    ...
    "dir",
    "orientation"
  ]), accordionRef = React.useRef(null), composedRef = useComposedRefs(accordionRef, forwardedRef), getItems = useCollection(__scopeAccordion || ACCORDION_CONTEXT), direction = useDirection(dir), isDirectionLTR = direction === "ltr", handleKeyDown = composeEventHandlers(props.onKeyDown, function(event) {
  ...
  return /* @__PURE__ */ _jsx(AccordionImplProvider, {
    ...
    children: /* @__PURE__ */ _jsx(Collection.Slot, {
      ...
      children: /* @__PURE__ */ _jsx(YStack, _object_spread({
...
}), ITEM_NAME = "AccordionItem", _createStyledContext3 = createStyledContext(), AccordionItemProvider = _createStyledContext3.Provider, useAccordionItemContext = _createStyledContext3.useStyledContext, AccordionItem = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  ...
  return /* @__PURE__ */ _jsx(AccordionItemProvider, {
    ...
    disabled,
    triggerId,
    children: /* @__PURE__ */ _jsx(Collapsible, _object_spread_props(_object_spread({
...
var HEADER_NAME = "AccordionHeader", AccordionHeader = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  ...
  return /* @__PURE__ */ _jsx(H1, _object_spread_props(_object_spread({
    "data-orientation": accordionContext.orientation,
...
var AccordionTriggerFrame = styled(Collapsible.Trigger, {
  ...
  return /* @__PURE__ */ _jsx(Collection.ItemSlot, {
    __scopeCollection: __scopeAccordion || ACCORDION_CONTEXT,
    children: /* @__PURE__ */ _jsx(AccordionTriggerFrame, _object_spread_props(_object_spread({
      //   @ts-ignore
      __scopeCollapsible: __scopeAccordion || ACCORDION_CONTEXT,
  ...
  return /* @__PURE__ */ _jsx(AccordionContentFrame, _object_spread_props(_object_spread({
    role: "region",
  ...
  var onLayout = useEvent(function(param) {
