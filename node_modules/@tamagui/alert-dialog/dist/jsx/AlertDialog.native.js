...
var ROOT_NAME = "AlertDialog", _createContextScope = _sliced_to_array(createContextScope(ROOT_NAME, [
  createDialogScope
]), 2), createAlertDialogContext = _createContextScope[0], createAlertDialogScope = _createContextScope[1], useDialogScope = createDialogScope(), TRIGGER_NAME = "AlertDialogTrigger", NativeAlertDialogTriggerFrame = styled(View, {
  name: TRIGGER_NAME
  ...
  if (props.__native) {
    ...
    return /* @__PURE__ */ _jsx(NativeAlertDialogTriggerFrame, _object_spread_props(_object_spread({}, rest), {
  ...
  return /* @__PURE__ */ _jsx(DialogTrigger, _object_spread_props(_object_spread({}, dialogScope, triggerProps), {
    ref: forwardedRef
  }));
});
...
var PORTAL_NAME = "AlertDialogPortal", AlertDialogPortal = function(props) {
  ...
  return /* @__PURE__ */ _jsx(DialogPortal, _object_spread({}, dialogScope, portalProps));
};
...
var OVERLAY_NAME = "AlertDialogOverlay", AlertDialogOverlayFrame = styled(DialogOverlayFrame, {
  ...
  return /* @__PURE__ */ _jsx(DialogOverlay, _object_spread_props(_object_spread({}, dialogScope, overlayProps), {
    ref: forwardedRef
  }));
}));
...
var CONTENT_NAME = "AlertDialogContent", _createAlertDialogContext = _sliced_to_array(createAlertDialogContext(CONTENT_NAME), 2), AlertDialogContentProvider = _createAlertDialogContext[0], useAlertDialogContentContext = _createAlertDialogContext[1], AlertDialogContent = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  var __scopeAlertDialog = props.__scopeAlertDialog, children = props.children, contentProps = _object_without_properties(props, [
    "__scopeAlertDialog",
    "children"
  ]), dialogScope = useDialogScope(__scopeAlertDialog), contentRef = React.useRef(null), composedRefs = useComposedRefs(forwardedRef, contentRef), cancelRef = React.useRef(null);
  return /* @__PURE__ */ _jsx(DialogWarningProvider, {
    ...
    children: /* @__PURE__ */ _jsx(AlertDialogContentProvider, {
      ...
      cancelRef,
      children: /* @__PURE__ */ _jsxs(DialogContent, _object_spread_props(_object_spread({
        // @ts-ignore
        role: "alertdialog"
...
var TITLE_NAME = "AlertDialogTitle", AlertDialogTitle = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  ...
  return /* @__PURE__ */ _jsx(DialogTitle, _object_spread_props(_object_spread({}, dialogScope, titleProps), {
    ref: forwardedRef
  }));
});
...
var DESCRIPTION_NAME = "AlertDialogDescription", AlertDialogDescription = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  ...
  return /* @__PURE__ */ _jsx(DialogDescription, _object_spread_props(_object_spread({}, dialogScope, descriptionProps), {
    ref: forwardedRef
  }));
});
...
var ACTION_NAME = "AlertDialogAction", AlertDialogAction = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  ...
  return /* @__PURE__ */ _jsx(DialogClose, _object_spread_props(_object_spread({}, dialogScope, actionProps), {
    ref: forwardedRef
  }));
});
...
var CANCEL_NAME = "AlertDialogCancel", AlertDialogCancel = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  var __scopeAlertDialog = props.__scopeAlertDialog, cancelProps = _object_without_properties(props, [
    "__scopeAlertDialog"
  ]), cancelRef = useAlertDialogContentContext(CANCEL_NAME, __scopeAlertDialog).cancelRef, dialogScope = useDialogScope(__scopeAlertDialog), ref = useComposedRefs(forwardedRef, cancelRef);
  return /* @__PURE__ */ _jsx(DialogClose, _object_spread_props(_object_spread({}, dialogScope, cancelProps), {
    ref
  }));
});
...
var DescriptionWarning = function(param) {
  ...
  var __scopeAlertDialog = props.__scopeAlertDialog, native = props.native, alertDialogProps = _object_without_properties(props, [
    "__scopeAlertDialog",
    "native"
  ]), dialogScope = useDialogScope(__scopeAlertDialog), _useControllableState = _sliced_to_array(useControllableState({
    prop: props.open,
  ...
  }) : /* @__PURE__ */ _jsx(Dialog, _object_spread_props(_object_spread({}, dialogScope, alertDialogProps), {
    modal: !0
  }));
};
