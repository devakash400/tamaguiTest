...
var AnimatePresence = function(param) {
  var children = param.children, enterVariant = param.enterVariant, exitVariant = param.exitVariant, enterExitVariant = param.enterExitVariant, _param_initial = param.initial, initial = _param_initial === void 0 ? !0 : _param_initial, onExitComplete = param.onExitComplete, exitBeforeEnter = param.exitBeforeEnter, _param_presenceAffectsLayout = param.presenceAffectsLayout, presenceAffectsLayout = _param_presenceAffectsLayout === void 0 ? !0 : _param_presenceAffectsLayout, custom = param.custom, _useContext_forceRender, forceRender = (_useContext_forceRender = (0, import_react.useContext)(import_LayoutGroupContext.LayoutGroupContext).forceRender) !== null && _useContext_forceRender !== void 0 ? _useContext_forceRender : (0, import_use_force_update.useForceUpdate)(), filteredChildren = onlyElements(children), presentChildren = (0, import_react.useRef)(filteredChildren), allChildren = (0, import_react.useRef)(/* @__PURE__ */ new Map()).current, exiting = (0, import_react.useRef)(/* @__PURE__ */ new Set()).current;
