...
function createAnimations(animations) {
  return {
    ...
    useAnimations: (animationProps) => {
      ...
      const animateStr = JSON.stringify(animate), styles = useMemo(() => JSON.parse(animateStr), [animateStr]), isExiting = !!presence?.[1], presenceContext = useContext(PresenceContext), usePresenceValue = presence || void 0, transition = {
