...
var import_jsx_runtime = require("react/jsx-runtime"), import_focusable = require("@tamagui/focusable"), import_checkbox_headless = require("@tamagui/checkbox-headless"), import_core = require("@tamagui/core"), import_font_size = require("@tamagui/font-size"), import_get_token = require("@tamagui/get-token"), import_helpers_tamagui = require("@tamagui/helpers-tamagui"), import_use_controllable_state = require("@tamagui/use-controllable-state"), import_react = __toESM(require("react")), import_Checkbox = require("./Checkbox"), import_CheckboxStyledContext = require("./CheckboxStyledContext");
  ...
  var FrameComponent = Frame.styleable(function(_props, forwardedRef) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckboxContext.Provider, {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_CheckboxStyledContext.CheckboxStyledContext.Provider, {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Frame, _object_spread_props(_object_spread(_object_spread_props(_object_spread(_object_spread_props(_object_spread({}, !unstyled && {
            width: size,
            height: size
          }), {
            tag: "button",
    ...
    return forceMount || (0, import_checkbox_headless.isIndeterminate)(context.checked) || context.checked === !0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Indicator, _object_spread_props(_object_spread({
      pointerEvents: "none"
    }, indicatorProps), {
      ref: forwardedRef,
      children
