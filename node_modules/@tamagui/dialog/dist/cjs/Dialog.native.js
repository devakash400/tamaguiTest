...
var DIALOG_NAME = "Dialog", _createContextScope = _sliced_to_array((0, import_create_context.createContextScope)(DIALOG_NAME), 2), createDialogContext = _createContextScope[0], createDialogScope = _createContextScope[1], _createDialogContext = _sliced_to_array(createDialogContext(DIALOG_NAME), 2), DialogProvider = _createDialogContext[0], useDialogContext = _createDialogContext[1], TRIGGER_NAME = "DialogTrigger", DialogTriggerFrame = (0, import_core.styled)(import_core.View, {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_stacks.ButtonNestingContext.Provider, {
    value: !0,
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTriggerFrame, _object_spread_props(_object_spread({
...
var PORTAL_NAME = "DialogPortal", _createDialogContext1 = _sliced_to_array(createDialogContext(PORTAL_NAME, {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_portal.PortalItem, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogPortalItemContent, _object_spread_props(_object_spread({}, props), {
      themeName,
      context
    }))
  });
...
function DialogPortalItemContent(props) {
  ...
  })), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogProvider, _object_spread_props(_object_spread({
    scope: __scopeDialog
  }, context), {
...
var DialogPortal = function(props) {
  ...
  if (context.modal) {
    ...
    var framedContents = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PortalProvider, {
      scope: __scopeDialog,
      forceMount,
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogPortalFrame, _object_spread_props(_object_spread({
...
var PassthroughTheme = function(param) {
  ...
  return !forceMount && (!context.modal || showSheet) ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogOverlayImpl, _object_spread_props(_object_spread({
    context
  }, overlayProps), {
    ref: forwardedRef
  }));
...
var DialogOverlayImpl = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  ...
  return (
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogOverlayFrame, _object_spread_props(_object_spread({
      "data-state": getState(context.open),
  ...
  var __scopeDialog = _param.__scopeDialog, props = _object_without_properties(_param, [
    ...
    "forceMount"
  ]), context = useDialogContext(CONTENT_NAME, __scopeDialog), contents = context.modal ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContentModal, _object_spread_props(_object_spread({
    context
  }, contentProps), {
    ref: forwardedRef
  })) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContentNonModal, _object_spread_props(_object_spread({
    context
  }, contentProps), {
    ref: forwardedRef
  }));
...
var DialogContentModal = /* @__PURE__ */ React.forwardRef(function(_param, forwardedRef) {
  ...
  return import_constants.isWeb && React.useEffect(function() {
    ...
    context.open
  ]), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContentImpl, _object_spread_props(_object_spread(_object_spread_props(_object_spread({}, props), {
    context,
    ref: composedRefs,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContentImpl, _object_spread_props(_object_spread({}, props), {
    ref: forwardedRef,
    trapFocus: !1,
  ...
  var __scopeDialog = props.__scopeDialog, trapFocus = props.trapFocus, onOpenAutoFocus = props.onOpenAutoFocus, onCloseAutoFocus = props.onCloseAutoFocus, disableOutsidePointerEvents = props.disableOutsidePointerEvents, onEscapeKeyDown = props.onEscapeKeyDown, onPointerDownOutside = props.onPointerDownOutside, onFocusOutside = props.onFocusOutside, onInteractOutside = props.onInteractOutside, context = props.context, contentProps = _object_without_properties(props, [
    ...
    "onInteractOutside",
    "context"
  ]), contentRef = React.useRef(null), composedRefs = (0, import_compose_refs.useComposedRefs)(forwardedRef, contentRef), showSheet = useShowDialogSheet(context), contents = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContentFrame, _object_spread({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitleFrame, _object_spread_props(_object_spread({
    id: context.titleId
  }, titleProps), {
    ref: forwardedRef
  }));
...
var DialogDescriptionFrame = (0, import_core.styled)(import_text.Paragraph, {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogDescriptionFrame, _object_spread_props(_object_spread({
...
var CLOSE_NAME = "DialogClose", DialogCloseFrame = (0, import_core.styled)(import_core.View, {
  ...
  return isSheet && !displayWhenAdapted ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogCloseFrame, _object_spread_props(_object_spread({
...
var TITLE_WARNING_NAME = "DialogTitleWarning", _createContext = _sliced_to_array((0, import_create_context.createContext)(TITLE_WARNING_NAME, {
  ...
  return React.useImperativeHandle(ref, function() {
    ...
    setOpen
  ]), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdaptProvider, {
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogProvider, _object_spread_props(_object_spread({}, context), {
