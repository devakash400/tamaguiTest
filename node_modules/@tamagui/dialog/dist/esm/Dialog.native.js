...
var PassthroughTheme = function(param) {
  ...
  return !forceMount && (!context.modal || showSheet) ? null : /* @__PURE__ */ _jsx(DialogOverlayImpl, _object_spread_props(_object_spread({
    context
  }, overlayProps), {
    ref: forwardedRef
  }));
...
var DialogOverlayImpl = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  ...
  return (
    ...
    /* @__PURE__ */ _jsx(DialogOverlayFrame, _object_spread_props(_object_spread({
      "data-state": getState(context.open),
