...
var POPOVER_SCOPE = "PopoverScope", PopoverContext = (0, import_core.createStyledContext)({}), usePopoverContext = PopoverContext.useStyledContext, PopoverAnchor = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  ...
  ]), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_popper.PopperAnchor, _object_spread_props(_object_spread({
  ...
  if (!props.children)
    return null;
  var trigger = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_core.View, _object_spread_props(_object_spread({
  ...
  return context.open && isFullyHidden && setIsFullyHidden(!1), React.useEffect(function() {
    ...
    context.open
  ]), !context.keepChildrenMounted && isFullyHidden ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverContentPortal, {
    __scopePopover,
    zIndex: props.zIndex,
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_core.Stack, {
      pointerEvents: context.open ? "auto" : "none",
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverContentImpl, _object_spread_props(_object_spread({}, contentImplProps), {
        disableRemoveScroll,
        ref: composedRefs,
        setIsFullyHidden,
        __scopePopover,
...
function PopoverRepropagateContext(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_popper.PopperContext.Provider, _object_spread_props(_object_spread({
    scope: props.scope
  }, props.popperContext), {
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverContext.Provider, _object_spread_props(_object_spread({}, props.context), {
...
var PopoverContentImpl = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  ...
  if (context.breakpointActive) {
    ...
    return (import_react_native.Platform.OS === "android" || import_react_native.Platform.OS === "ios") && (content = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_popper.PopperContext.Provider, _object_spread_props(_object_spread({
      scope: __scopePopover || POPOVER_SCOPE
    }, popperContext), {
      children: childrenWithoutScrollView
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_animate.Animate, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_popper.PopperContent, _object_spread_props(_object_spread({
      __scopePopper: __scopePopover || POPOVER_SCOPE,
  ...
  var children = props.children, openProp = props.open, defaultOpen = props.defaultOpen, onOpenChange = props.onOpenChange, __scopePopover = props.__scopePopover, keepChildrenMounted = props.keepChildrenMounted, hoverable = props.hoverable, disableFocus = props.disableFocus, restProps = _object_without_properties(props, [
  ...
  }), 2), open = _useControllableState[0], setOpen = _useControllableState[1], handleOpenChange = (0, import_core.useEvent)(function(val, via) {
    ...
    hoverable,
    disableFocus
  }), _React_useState1 = _sliced_to_array(React.useState(), 2), anchorTo = _React_useState1[0], setAnchorToRaw = _React_useState1[1], setAnchorTo = (0, import_core.createShallowSetState)(setAnchorToRaw);
  ...
  var popoverContext = {
    ...
    keepChildrenMounted
  }, contents = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_popper.Popper, _object_spread_props(_object_spread({
    __scopePopper: __scopePopover || POPOVER_SCOPE,
    stayInFrame: !0
  }, restProps), {
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverContext.Provider, _object_spread_props(_object_spread({
