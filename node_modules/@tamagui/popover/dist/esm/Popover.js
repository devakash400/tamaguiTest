...
const POPOVER_SCOPE = "PopoverScope", PopoverContext = createStyledContext({}), usePopoverContext = PopoverContext.useStyledContext, PopoverAnchor = React.forwardRef(function(props, forwardedRef) {
  ...
  React.forwardRef(function(props, forwardedRef) {
    const {
      ...
      __scopePopover,
      ...contentImplProps
    } = props, context = usePopoverContext(__scopePopover), contentRef = React.useRef(null), composedRefs = useComposedRefs(forwardedRef, contentRef), isRightClickOutsideRef = React.useRef(!1), [isFullyHidden, setIsFullyHidden] = React.useState(!context.open);
    ...
    }, [context.open]), !context.keepChildrenMounted && isFullyHidden ? null : /* @__PURE__ */ jsx(PopoverContentPortal, { __scopePopover, zIndex: props.zIndex, children: /* @__PURE__ */ jsx(Stack, { pointerEvents: context.open ? "auto" : "none", children: /* @__PURE__ */ jsx(
      PopoverContentImpl,
      {
        ...contentImplProps,
        disableRemoveScroll,
...
const PopoverContentImpl = React.forwardRef(function(props, forwardedRef) {
  const {
    ...
    setIsFullyHidden,
    ...contentProps
  } = props, context = usePopoverContext(__scopePopover), { open, keepChildrenMounted } = context, popperContext = usePopperContext(__scopePopover || POPOVER_SCOPE), handleExitComplete = React.useCallback(() => {
    setIsFullyHidden?.(!0);
  }, [setIsFullyHidden]);
  if (context.breakpointActive) {
    ...
    let content = /* @__PURE__ */ jsx(ResetPresence, { children: childrenWithoutScrollView });
            ...
            RemoveScroll,
            {
              ...
              children: /* @__PURE__ */ jsx(ResetPresence, { children: /* @__PURE__ */ jsx(
                FocusScope,
                {
                  ...
                  children: isWeb ? /* @__PURE__ */ jsx("div", { style: dspContentsStyle, children }) : children
                }
              ) })
            }
          )
  ...
  React.forwardRef(
    (props, forwardedRef) => {
      const {
        ...
        hoverable,
        disableFocus
      }), [anchorTo, setAnchorToRaw] = React.useState(), setAnchorTo = createShallowSetState(
        setAnchorToRaw
      );
