...
const PopperAnchor = YStack.extractable(
  React.forwardRef(
    function(props, forwardedRef) {
      const { virtualRef, __scopePopper, ...anchorProps } = props, { getReferenceProps, refs } = usePopperContext(__scopePopper), ref = React.useRef(null), composedRefs = useComposedRefs(forwardedRef, ref, refs.setReference);
      if (React.useEffect(() => {
  ...
  const contents = React.useMemo(() => /* @__PURE__ */ jsx(
    PopperContentFrame,
    {
