...
var PopperContext = createStyledContext({}), usePopperContext = PopperContext.useStyledContext, PopperProvider = PopperContext.Provider, checkFloating = {
  name: "checkFloating",
  fn: function(data) {
    return {
      data: {
...
var PopperAnchor = YStack.extractable(/* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  var virtualRef = props.virtualRef, __scopePopper = props.__scopePopper, anchorProps = _object_without_properties(props, [
    "virtualRef",
    "__scopePopper"
  ]), _usePopperContext = usePopperContext(__scopePopper), getReferenceProps = _usePopperContext.getReferenceProps, refs = _usePopperContext.refs, ref = React.useRef(null), composedRefs = useComposedRefs(forwardedRef, ref, refs.setReference);
  ...
  var _context_arrowStyle, _context_arrowStyle1, __scopePopper = propsIn.__scopePopper, rest = _object_without_properties(propsIn, [
    "__scopePopper"
  ]), props = useProps(rest), offset = props.offset, sizeProp = props.size, _props_borderWidth = props.borderWidth, borderWidth = _props_borderWidth === void 0 ? 0 : _props_borderWidth, arrowProps = _object_without_properties(props, [
    "offset",
    "size",
    "borderWidth"
  ]), context = usePopperContext(__scopePopper), sizeVal = sizeProp ?? context.size, sizeValResolved = getVariableValue(getSpace(sizeVal, {
    shift: -2,
    bounds: [
      2
    ]
  })), size = Math.max(0, +sizeValResolved), placement = context.placement, refs = useComposedRefs(context.arrowRef, forwardedRef), x = ((_context_arrowStyle = context.arrowStyle) === null || _context_arrowStyle === void 0 ? void 0 : _context_arrowStyle.x) || 0, y = ((_context_arrowStyle1 = context.arrowStyle) === null || _context_arrowStyle1 === void 0 ? void 0 : _context_arrowStyle1.y) || 0, primaryPlacement = placement ? placement.split("-")[0] : "top", arrowStyle = {
    x,
    y,
    width: size,
    height: size
