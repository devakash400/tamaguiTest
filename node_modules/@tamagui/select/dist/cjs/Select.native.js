...
var GROUP_NAME = "SelectGroup", _createSelectContext = _sliced_to_array((0, import_context.createSelectContext)(GROUP_NAME), 2), SelectGroupContextProvider = _createSelectContext[0], useSelectGroupContext = _createSelectContext[1], SelectGroupFrame = (0, import_core.styled)(import_stacks.YStack, {
  name: GROUP_NAME,
  width: "100%"
  ...
  variants: {
    size: {
      "...size": function(val, extras) {
        var tokens = extras.tokens, paddingHorizontal = (0, import_core.getVariableValue)(tokens.space[val]), _tokens_radius_val;
        return {
...
var SelectSeparator = (0, import_core.styled)(import_separator.Separator, {
  ...
  }), when = _useAdaptParent.when, AdaptProvider = _useAdaptParent.AdaptProvider, sheetBreakpoint = when, isSheet = (0, import_useSelectBreakpointActive.useSelectBreakpointActive)(sheetBreakpoint), SelectImpl = isSheet || !import_constants.isWeb ? SelectSheetImpl : import_SelectImpl.SelectInlineImpl, forceUpdate = React.useReducer(function() {
    return {};
  }, {})[1], _React_useState = _sliced_to_array(React.useState(null), 2), selectedItem = _React_useState[0], setSelectedItem = _React_useState[1], _useControllableState = _sliced_to_array((0, import_use_controllable_state.useControllableState)({
    prop: openProp,
    defaultProp: defaultOpen || !1,
    onChange: onOpenChange
  }), 2), open = _useControllableState[0], setOpen = _useControllableState[1], _useControllableState1 = _sliced_to_array((0, import_use_controllable_state.useControllableState)({
    prop: valueProp,
