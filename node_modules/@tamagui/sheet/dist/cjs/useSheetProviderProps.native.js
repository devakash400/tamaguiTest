...
function useSheetProviderProps(props, state) {
  var options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, handleRef = import_react.default.useRef(null), contentRef = import_react.default.useRef(null), _useState = _sliced_to_array((0, import_react.useState)(0), 2), frameSize = _useState[0], setFrameSize = _useState[1], _useState1 = _sliced_to_array((0, import_react.useState)(0), 2), maxContentSize = _useState1[0], setMaxContentSize = _useState1[1], _props_snapPointsMode, snapPointsMode = (_props_snapPointsMode = props.snapPointsMode) !== null && _props_snapPointsMode !== void 0 ? _props_snapPointsMode : "percent", _props_snapPoints, snapPointsProp = (_props_snapPoints = props.snapPoints) !== null && _props_snapPoints !== void 0 ? _props_snapPoints : snapPointsMode === "percent" ? [
    80
  ] : snapPointsMode === "constant" ? [
    256
  ] : [
    "fit"
  ], hasFit = snapPointsProp[0] === "fit", snapPoints = (0, import_react.useMemo)(function() {
    ...
    transition: !0
  }), 2), position_ = _useControllableState[0], setPositionImmediate = _useControllableState[1], position = state.open === !1 ? -1 : position_, open = state.open, setPosition = (0, import_react.useCallback)(function(next) {
