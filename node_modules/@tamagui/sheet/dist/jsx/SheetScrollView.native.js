...
var SHEET_SCROLL_VIEW_NAME = "SheetScrollView", SheetScrollView = /* @__PURE__ */ forwardRef(function(_param, ref) {
  var __scopeSheet = _param.__scopeSheet, children = _param.children, onScroll = _param.onScroll, props = _object_without_properties(_param, [
    ...
    "children",
    "onScroll"
  ]), context = useSheetContext(SHEET_SCROLL_VIEW_NAME, __scopeSheet), scrollBridge = context.scrollBridge, scrollRef = useRef(null), state = useRef({
    lastPageY: 0,
    dragAt: 0,
    dys: [],
