...
function getESBuildConfig(_param, platform, aliases) {
  ...
  var resolvedEntryPoints = resolvePlatformSpecificEntries ? entryPoints.map(resolveWebOrNativeSpecificEntry) : entryPoints, res = _object_spread({
    bundle: !0,
    ...
    plugins: [
      ...
      esbuildAliasPlugin(_object_spread({}, aliases))
    ]
  }, options);
  return res;
}
...
function _asyncLock() {
  ...
  _async_to_generator(function(props) {
    ...
    return _ts_generator(this, function(_state) {
      switch (_state.label) {
        case 0:
          return lockFile = join(dirname(props.outfile), basename(props.outfile, ".lock")), [
            4,
