...
var cache = /* @__PURE__ */ new Map(), pending = /* @__PURE__ */ new Map(), loadCmd = "".concat(join(__dirname, "loadFile.js")), exited = !1, child = null;
function forkChild() {
  child = fork(loadCmd, [], {
    execArgv: [
      "-r",
  ...
  return _getStaticBindingsForScope = _async_to_generator(function(scope) {
    ...
    return _ts_generator(this, function(_state) {
      switch (_state.label) {
        case 0:
          _loop = function(k3) {
            var binding = bindings[k3], sourceModule = getSourceModule(k3, binding);
            if (sourceModule) {
            ...
            try {
              return ret[k3] = evaluateAstNode(dec.init, void 0, shouldPrintDebug), bindingCache[cacheKey] = ret[k3], "continue";
            } catch {
            }
