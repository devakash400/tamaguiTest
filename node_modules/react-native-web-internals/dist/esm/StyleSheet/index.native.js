...
var staticStyleMap = /* @__PURE__ */ new WeakMap(), sheet = createSheet();
...
function compileAndInsertAtomic(style) {
  var _atomic = _sliced_to_array(atomic(preprocess(style)), 2), compiledStyle = _atomic[0], compiledOrderedRules = _atomic[1];
  return insertRules(compiledOrderedRules), compiledStyle;
}
function compileAndInsertReset(style, key) {
  var _classic = _sliced_to_array(classic(style, key), 2), compiledStyle = _classic[0], compiledOrderedRules = _classic[1];
  return insertRules(compiledOrderedRules), compiledStyle;
}
